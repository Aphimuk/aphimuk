    ...
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body p-4 p-md-5">
            <form method="post" action="" class="row g-4">
                ...
                <div class="col-md-4">
                    <label for="birthday" class="form-label fw-bold">วันเดือนปีเกิด <span class="text-danger">*</span></label>
...
if (isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO application(a_position, a_prefix, a_fullname, a_birthday, a_education, a_special_skill, a_work_experience)
    VALUES('$position', '$prefix', '$fullname', '$birthday', '$education', '$special_skill', '$work_experience')";
