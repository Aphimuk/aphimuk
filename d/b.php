...
<body>
<h1>ฟอร์มรับข้อมูล-อภิมุข แสงดอกไม้(แฟร้งค์)</h1>
...
สีที่ชอบ <input type="color" name="color">
...
<button type="button" onClick="window.location='https://www.youtube.com/watch?v=Ay7Fg3OwGeQ&list=RDvXhnmZxm3Co&index=16'">เพลงคิดฮอด</button>
